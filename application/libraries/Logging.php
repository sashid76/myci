...
class EmailLogger extends Logger{
    ...
    protected function do_log($log_entry){
        ...
        $emailconfig = Array(
            'protocol' => $this->CI->config->item('aibd_protocol'),
            'smtp_host' => $this->CI->config->item('aibd_smtp_host'),
            'smtp_port' => $this->CI->config->item('aibd_smtp_port'),
            'smtp_user' => $this->CI->config->item('aibd_smtp_user'),
            'smtp_pass' => $this->CI->config->item('aibd_smtp_pass'),
            'mailtype' => $this->CI->config->item('aibd_mailtype'),
            'charset' => $this->CI->config->item('aibd_charset'),
            'wordwrap' => $this->CI->config->item('aibd_wordwrap'),
            'validate' => $this->CI->config->item('aibd_validate'),
            'newline' => $this->CI->config->item('aibd_newline')
        );  
