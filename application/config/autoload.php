...
*/
$autoload['libraries'] = array('database','formkey','session','mylibrary','mytools','flasher');
...
*/
$autoload['helper'] = array('url','form','file','cookie','nav_helper');
...
*/
$autoload['model'] = array('AppConfig_model');
