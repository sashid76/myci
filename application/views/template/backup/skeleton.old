...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <meta property="og:image" content="http://ss2.olympia.edu.my/assets/img/custom/logo.png" /> 
    <meta property="og:image:secure_url" content="https://ss2.olympia.edu.my/assets/img/custom/logo.png" />
    ...
    <!--
    <link rel="stylesheet" type="text/css" href="DataTables-1.10.11/css/dataTables.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="AutoFill-2.1.1/css/autoFill.bootstrap.css"/>
    <link rel="stylesheet" type="text/css" href="Buttons-1.1.2/css/buttons.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="ColReorder-1.3.1/css/colReorder.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="FixedColumns-3.2.1/css/fixedColumns.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="FixedHeader-3.1.1/css/fixedHeader.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="KeyTable-2.1.1/css/keyTable.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="Responsive-2.0.2/css/responsive.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="RowReorder-1.1.1/css/rowReorder.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="Scroller-1.4.1/css/scroller.bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="Select-1.1.2/css/select.bootstrap.min.css"/>    
    -->
  ...
  <body>
    ...
    */
    ...
    <!-- social icon -->
        <div class="bs-old-docs" style="z-index:999; width:100%; background-color:#ffffff;" data-spy="affix" data-offset-top='50'>
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="col-md-4"><a href="<?php echo base_url("/home/") ?>"><img height="70px;" src="<?php echo base_url(); ?>assets/img/custom/aibd_logo.jpg" alt="logo" style="margin-bottom:7px; margin-top:7px;" /></a></div>
                    <div class="col-md-4"><div style="padding-top: 10px;" id="notification"></div></div>
                    <div class="col-md-4 hidden-xs">
                        <ul class="list-inline pull-right apico">
                            ...
                            <li><a href="https://www.facebook.com/OlympiaCollege" target="_NEW"><span id="social_facebook1" class="apico-black apico-facebook-square"></span></a></li>
                            <li><a href="https://twitter.com/OlympiaCollege" target="_NEW"><span id="social_twitter1" class="apico-black apico-twitter-square"></span></a></li>
                            <li><a href="http://www.linkedin.com/company/olympia-college-sdn-bhd-" target="_NEW"><span id="social_linkedin1" class="apico-black apico-linkedin-square"></span></a></li>
                            <li><a href="#" target="_NEW"><span id="social_googleplus1" class="apico-black apico-google-plus-square"></span></a></li>
                            <li><a href="http://www.youtube.com/user/MyOlympiaCollege" target="_NEW"><span id="social_youtube1" class="apico-black apico-youtube-square"></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body">
                            ...
                            <i class="fa fa-opera"></i> Safari - Apple Macintosh<br>
                            <i class="fa fa-internet-explorer"></i> Opera<br>
                            <br>
    ...
    <script type="text/javascript" src="DataTables-1.10.11/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="DataTables-1.10.11/js/dataTables.bootstrap.min.js"></script>
    <script type="text/javascript" src="AutoFill-2.1.1/js/dataTables.autoFill.min.js"></script>
    <script type="text/javascript" src="AutoFill-2.1.1/js/autoFill.bootstrap.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/dataTables.buttons.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/buttons.bootstrap.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/buttons.colVis.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/buttons.flash.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/buttons.html5.min.js"></script>
    <script type="text/javascript" src="Buttons-1.1.2/js/buttons.print.min.js"></script>
    <script type="text/javascript" src="ColReorder-1.3.1/js/dataTables.colReorder.min.js"></script>
    <script type="text/javascript" src="FixedColumns-3.2.1/js/dataTables.fixedColumns.min.js"></script>
    <script type="text/javascript" src="FixedHeader-3.1.1/js/dataTables.fixedHeader.min.js"></script>
    <script type="text/javascript" src="KeyTable-2.1.1/js/dataTables.keyTable.min.js"></script>
    <script type="text/javascript" src="Responsive-2.0.2/js/dataTables.responsive.min.js"></script>
    <script type="text/javascript" src="Responsive-2.0.2/js/responsive.bootstrap.min.js"></script>
    <script type="text/javascript" src="RowReorder-1.1.1/js/dataTables.rowReorder.min.js"></script>
    <script type="text/javascript" src="Scroller-1.4.1/js/dataTables.scroller.min.js"></script>
    <script type="text/javascript" src="Select-1.1.2/js/dataTables.select.min.js"></script>
    -->
    ...
    <!-- highcharttable -->
    <script src="<?php echo base_url(JS . "third-party/highchart-table/highcharts.js"); ?>"></script>
    <script src="<?php echo base_url(JS . "third-party/highchart-table/jquery.highchartTable-min.js"); ?>"></script> 
    <!-- //highcharttable -->
        ...
        jQuery.noConflict()(function($){
             $(document).ready(function(){
                ...
                rplist = $('#rpcontactlist').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('rplist/get_rp_list')?>",
                        "type": "POST"
                    },
                ...
                RPDB = {
                    add_new_rpcontact: function() {
                        alert('add_new_rpcontact');
                    },
    ...
    <script type="text/javascript">
        jQuery.noConflict()(function($){
            $(document).ready(function(){
                ...
                $.getJSON(
                    'http://10.10.10.220/ci304/data.json', 
                    function(json) {
                        //alert("success");                   
                ...
                */
                ...
                $.ajax({
                    ...
                    type: "GET", 
                    url: "http://10.10.10.220/ci304/site.json",  
                    dataType: "json",
                    data: {},
                    timeout: 10000,
                    statusCode: {
